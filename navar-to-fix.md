...
Generated: 2026-04-23T07:32:34.812Z
...
- `accounts/urls.py` (135 bytes)
- `accounts/views.py` (285 bytes)
- `app/__init__.py` (0 bytes)
- `app/admin.py` (63 bytes)
- `app/apps.py` (81 bytes)
- `app/migrations/__init__.py` (0 bytes)
- `app/models.py` (464 bytes)
- `app/services.py` (8109 bytes)
- `app/static/css/main.css` (1224 bytes)
- `app/static/js/navbar.js` (901 bytes)
- `app/static/js/tailwind.config.js` (829 bytes)
- `app/templates/base/base.html` (1321 bytes)
- `app/templates/base/initial.html` (1265 bytes)
- `app/templates/components/card_movies.html` (3272 bytes)
- `app/templates/components/card_series.html` (3271 bytes)
- `app/templates/components/footer.html` (619 bytes)
- `app/templates/components/navbar.html` (5649 bytes)
...
- `app/templates/pages/personal_library.html` (33338 bytes)
- `app/templates/pages/search.html` (5822 bytes)
- `app/templates/pages/series.html` (128 bytes)
- `app/templates/pages/user_settings.html` (7713 bytes)
- `app/templates/registration/login.html` (3765 bytes)
- `app/templates/registration/singup.html` (2474 bytes)
- `app/tests.py` (60 bytes)
- `app/urls.py` (697 bytes)
- `app/views.py` (2743 bytes)
...
- `navbar.md` (215931 bytes)
- `pyproject.toml` (311 bytes)
- `SoftwareProject/__init__.py` (0 bytes)
- `SoftwareProject/asgi.py` (407 bytes)
- `SoftwareProject/settings.py` (3463 bytes)
- `SoftwareProject/urls.py` (924 bytes)
...
class Profile(models.Model):
    ...
    role = models.CharField(max_length=20, choices=[('admin', 'Admin'), ('user', 'User'), ('tech', 'Tech'), ('plataform', 'Plataform')], default='user')
        ...
        <div class="group flex flex-col gap-3 transition-all duration-500 hover:scale-105">
            ...
            <div class="aspect-[2/3] rounded-xl overflow-hidden relative cinematic-shadow hover-electric">
                ...
                <div
                    ...
                    <a href="{% url 'app:content_detail' 'movie' movie.id %}"
            ...
            <div class="px-1">
                <h3 class="font-bold text-sm truncate group-hover:text-primary transition-colors">
                    <a href="{% url 'app:content_detail' 'movie' movie.id %}">{{ movie.title }}</a>
                </h3>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
        ...
        <div class="group flex flex-col gap-3 transition-all duration-500 hover:scale-105">
            ...
            <div class="aspect-[2/3] rounded-xl overflow-hidden relative cinematic-shadow hover-electric">
                ...
                <div
                    class="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-end p-4">
                    <a href="{% url 'app:content_detail' 'series' serie.id %}"
                        class="bg-primary text-white text-center text-xs font-bold py-2 rounded-lg tracking-wide hover:bg-primary/80 block">
                        Watch now
                    </a>
                </div>
            ...
            <div class="px-1">
                <h3 class="font-bold text-sm truncate group-hover:text-primary transition-colors">
                    <a href="{% url 'app:content_detail' 'series' serie.id %}">{{ serie.title }}</a>
                </h3>
    ...
    <div class="relative" id="user-menu-wrapper">
      ...
      <div id="user-dropdown" class="hidden absolute right-0 mt-2 w-52 origin-top-right rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl z-[60] overflow-hidden">
        <div class="p-2 flex flex-col gap-1">
          ...
          <a href="personal_library" class="flex items-center gap-3 px-3 py-2.5 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-colors">
            <span class="material-symbols-outlined text-primary">video_library</span>
            Personal Library
          </a>

          <a href="user_settings" class="flex items-center gap-3 px-3 py-2.5 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-colors">
  ...
  <div class="relative z-10 pt-64 px-8 md:px-24 pb-24 max-w-7xl mx-auto">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
      ...
      <div class="lg:col-span-4 flex flex-col gap-8">
        ...
        <button
          class="glass-panel border border-white/5 hover:bg-white/10 text-white px-10 py-4 rounded-xl font-bold flex items-center gap-3 active:scale-95 transition-all">
...
{% block content %}
      ...
      <!-- Main Content -->
      <main class="flex-1 flex justify-center py-6 px-4 lg:px-8">
        <div class="w-full max-w-7xl flex flex-col gap-8">
          ...
          <div class="flex flex-col gap-6">
            ...
            >
              <div class="flex flex-col gap-2">
                ...
                <p class="text-text-secondary text-base font-normal">
                  Manage your watchlist and tracking history across all
                  platforms.
                </p>
              </div>
              <button
                class="hidden sm:flex h-10 items-center justify-center rounded-lg bg-primary hover:bg-primary/90 text-white gap-2 text-sm font-bold px-4 transition-colors shadow-lg shadow-primary/20"
              >
                <span class="material-symbols-outlined text-[20px]">add</span>
            ...
            <!-- Navigation Tabs -->
            <div class="border-b border-surface-highlight mt-2">
              <div class="flex gap-8 overflow-x-auto no-scrollbar">
                <a
                  class="flex flex-col items-center justify-center border-b-[3px] border-primary text-white pb-3 pt-2 min-w-[80px]"
                  href="#"
                >
                  <span class="text-sm font-bold tracking-wide">Watchlist</span>
                </a>
                <a
                  class="flex flex-col items-center justify-center border-b-[3px] border-transparent text-text-secondary hover:text-white pb-3 pt-2 min-w-[80px] transition-colors"
                  href="#"
                >
                  <span class="text-sm font-bold tracking-wide">Watching</span>
                </a>
                <a
                  class="flex flex-col items-center justify-center border-b-[3px] border-transparent text-text-secondary hover:text-white pb-3 pt-2 min-w-[80px] transition-colors"
                  href="#"
                >
                  <span class="text-sm font-bold tracking-wide">Completed</span>
                </a>
                <a
                  class="flex flex-col items-center justify-center border-b-[3px] border-transparent text-text-secondary hover:text-white pb-3 pt-2 min-w-[80px] transition-colors"
                  href="#my-lists"
          ...
          <!-- My Lists Section -->
          <section class="flex flex-col gap-6" id="my-lists">
            <div class="flex items-center justify-between">
              ...
              <button
                class="flex h-9 items-center justify-center rounded-lg border border-surface-highlight hover:bg-surface-highlight text-white gap-2 text-xs font-bold px-4 transition-colors"
              >
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <!-- Favorites Card -->
              <div
                class="group relative overflow-hidden rounded-2xl bg-surface-dark border border-white/5 hover:border-primary/50 transition-all duration-300 p-5 cursor-pointer flex flex-col gap-4"
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-3">
                    <div
                      class="size-10 rounded-full bg-red-500/10 flex items-center justify-center text-red-500"
                    >
                      <span
                        class="material-symbols-outlined fill-current text-[20px]"
                        >favorite</span
                      >
                    </div>
                    <div>
                      ...
                      <p class="text-xs text-text-secondary">12 items saved</p>
                    </div>
                  </div>
                  <span
                    class="material-symbols-outlined text-text-secondary group-hover:text-white transition-colors"
                    >chevron_right</span
                  >
                </div>
                <!-- Preview Stacks -->
                <div class="flex items-center -space-x-4 overflow-hidden py-2">
                  <div
                    class="size-24 rounded-lg bg-surface-highlight border border-white/10 rotate-[-5deg] overflow-hidden transform group-hover:translate-y-[-4px] transition-transform duration-300 shadow-xl"
                  >
                    <img
                      alt="Preview"
                      class="w-full h-full object-cover"
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuB6kHL1keoTiQ4W0Uu3hxUsZfIzSTOt-eG_T1Ow2-ZsBn0bUKFSgonzmWqE1NiQcE5EBxWkIVLBKUvFsc1CSbBOsvtniMJGq4bn_lu_awNFEzeuCL5KJLbSdgpuB6TWy6spSg1r2VkHDW76F04Lc1NQzNrtls7xf1CgWXDH7jEOlFH2aPcPErBo-QpuVEoefy2I617ViKPbf6VHAz36FR5ZV1KtqjKCPucgz-P0YcZ0InbhXWr_Mq84N9WiqkdFx6JIgsNJcE8r4vMd"
                    />
                  </div>
                  <div
                    class="size-24 rounded-lg bg-surface-highlight border border-white/10 z-10 overflow-hidden shadow-xl transform group-hover:translate-y-[-8px] transition-transform duration-300"
                  >
                    <img
                      alt="Preview"
                      class="w-full h-full object-cover"
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuABWN0AQ9kk9F8gKA1DXFlPVtgR_mA01K-dVsf0EvP57PlL93ViVHaC608X_ExeNoUP0vBvARVToJIkhDCmHCbC5H47ZM6--w49BVcZo9NiIG1pakO7XRbuvf2zIO7471fbvTVUZvWD0fqImsTLAhs3907PYwSUX3dWBcD-skTwlMDKV34CkhB1cobXnsJurzLKSCV7Ur4F9ZoBY3PbPnur3wTuxOsTbN9kRJbzKDET0lp4VBReS1sHlmhF9eryq9EgH_QMxk0rcNKn"
                    />
                  </div>
                  <div
                    class="size-24 rounded-lg bg-surface-highlight border border-white/10 rotate-[5deg] overflow-hidden transform group-hover:translate-y-[-4px] transition-transform duration-300 shadow-xl"
                  >
                    <img
                      alt="Preview"
                      class="w-full h-full object-cover"
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuBC0_DE0ACE3E_4hgAUoCCwD5tf3j7LjbywJZYrakU3vbOG9DEADsF6RTCiWDQO6Y7fw4QQjUjxeH2XzsuveBCu_4qgYC-AlkkIrfGE_2ZtlXeaIu6cX9uQcY538dnYRhrAHP8MYty1M4pG6i1AmuR2OVPjZBJ2cbBOFf_Z_N5kl9_yc6JN0SIITK41BTU_Ng8fLGW40tH1zTq_QsyUlWHIg7wbSfCBdQNVqFt9aUAOd3yKq10SOJlO9xIT5DEoBfahwxXPhdjWaj_n"
                    />
                  </div>
                </div>
              </div>
              ...
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p class="text-xs text-text-secondary">8 shows tracked</p>
                    </div>
                  </div>
                  <span
                    class="material-symbols-outlined text-text-secondary group-hover:text-white transition-colors"
                ...
                <div class="flex gap-2">
                  <div
                    class="flex-1 h-20 rounded-lg bg-surface-highlight/50 border border-white/5 overflow-hidden"
                  >
                    <img
                      alt="Show"
              ...
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-3">
                    <div
                      class="size-10 rounded-full bg-cyan-500/10 flex items-center justify-center text-cyan-400"
                    >
                      <span class="material-symbols-outlined text-[20px]"
                        >rocket_launch</span
                      >
                ...
                <div class="flex gap-2">
                  ...
                  >
                    <img
                      alt="Show"
                      class="w-full h-full object-cover opacity-60 group-hover:opacity-100 transition-opacity"
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuAwq3FpvUbD_FyPsVszFoX6F488rTZSagpDYPJGoIulORDYb1K39irS9hYrTx1c0yTqNmIOJjZLSP0S3vsTknbwZ7lDg7GepNl4dSC0fK_SIEJTGBv39jBNyikYve3xqhZRqDX1AQVBZDg_jp4aGHUA7u3pW7el1qNmbJ-wcVRv2vJ3JOqvcnalBxyAYSv8fGLMCyvC2C9PntNtvQKeNyxRw9Ji5oNa1l0crFsZFShk54o8fH-kBPh1DZtauEtOp9aRx6JK0diUhgLv"
                    />
                  </div>
                  <div
                    class="flex-1 h-20 rounded-lg bg-surface-highlight/50 border border-white/5 flex items-center justify-center text-text-secondary"
                  >
          ...
          <!-- Controls & Filters -->
          <div class="flex flex-col lg:flex-row justify-between gap-4 py-2">
            <!-- Filters Left -->
            <div class="flex flex-wrap items-center gap-3">
              <button
                class="group flex h-9 items-center justify-center gap-2 rounded-lg bg-surface-highlight hover:bg-surface-highlight/80 pl-3 pr-2 text-white transition-all ring-1 ring-white/5"
              >
                <span class="text-sm font-medium">All Types</span>
                <span
                  class="material-symbols-outlined text-[18px] text-text-secondary group-hover:text-white"
                  >expand_more</span
                >
              </button>
              <button
                class="group flex h-9 items-center justify-center gap-2 rounded-lg bg-surface-dark hover:bg-surface-highlight pl-3 pr-2 text-text-secondary hover:text-white transition-all ring-1 ring-white/5"
              >
            ...
            <div class="flex items-center gap-2 ml-auto">
              <div
                class="h-9 flex items-center bg-surface-highlight rounded-lg p-1 ring-1 ring-white/5"
              >
                <button
                  class="size-7 flex items-center justify-center rounded bg-surface-dark text-white shadow-sm"
                >
                  <span class="material-symbols-outlined text-[18px]"
                    >grid_view</span
                  >
                ...
                <button
                  class="size-7 flex items-center justify-center rounded text-text-secondary hover:text-white hover:bg-surface-dark/50 transition-colors"
                >
                  <span class="material-symbols-outlined text-[18px]"
                    >view_list</span
                  >
              ...
              <div class="h-6 w-px bg-surface-highlight mx-2"></div>
              <button
                class="flex size-9 items-center justify-center rounded-lg bg-surface-highlight hover:bg-surface-highlight/80 text-white transition-colors ring-1 ring-white/5"
                title="Filter"
              >
                <span class="material-symbols-outlined text-[20px]"
                  >filter_list</span
          ...
          <!-- Grid Content -->
          <div
            class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-x-4 gap-y-8 pb-10"
          >
            <!-- Card 1 -->
            <div class="group flex flex-col gap-3 cursor-pointer">
              <div
                class="relative aspect-[2/3] w-full overflow-hidden rounded-xl bg-surface-highlight ring-1 ring-white/10 transition-all duration-300 group-hover:ring-primary/50 group-hover:shadow-lg group-hover:shadow-primary/10"
              >
                <img
                  alt="Movie poster showing a sci-fi landscape"
                  class="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuB6kHL1keoTiQ4W0Uu3hxUsZfIzSTOt-eG_T1Ow2-ZsBn0bUKFSgonzmWqE1NiQcE5EBxWkIVLBKUvFsc1CSbBOsvtniMJGq4bn_lu_awNFEzeuCL5KJLbSdgpuB6TWy6spSg1r2VkHDW76F04Lc1NQzNrtls7xf1CgWXDH7jEOlFH2aPcPErBo-QpuVEoefy2I617ViKPbf6VHAz36FR5ZV1KtqjKCPucgz-P0YcZ0InbhXWr_Mq84N9WiqkdFx6JIgsNJcE8r4vMd"
                />
                <div
                  class="absolute top-2 right-2 flex flex-col gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200"
                >
                  <button
                    class="size-8 rounded-full bg-black/60 backdrop-blur-md text-white flex items-center justify-center hover:bg-primary transition-colors"
                  >
                    <span class="material-symbols-outlined text-[18px]"
                      >check</span
                    >
                  ...
                  <button
                    class="size-8 rounded-full bg-black/60 backdrop-blur-md text-white flex items-center justify-center hover:bg-red-500 transition-colors"
                  >
                    <span class="material-symbols-outlined text-[18px]"
                      >favorite</span
                    >
                ...
                <div
                  class="absolute bottom-2 left-2 px-2 py-1 bg-black/60 backdrop-blur-md rounded text-xs font-bold text-white"
                >
                  98% Match
                </div>
              </div>
              <div class="flex flex-col gap-1">
                <h3
                  class="text-base font-bold text-white leading-tight truncate group-hover:text-primary transition-colors"
                >
                  Dune: Part Two
                </h3>
                <div
                ...
                >
                  <span>2024</span>
                  <span class="size-1 rounded-full bg-text-secondary/50"></span>
                  <span>Sci-Fi</span>
                  <span class="size-1 rounded-full bg-text-secondary/50"></span>
                  <span class="flex items-center gap-1"
                    ><span
                      class="material-symbols-outlined text-[12px] text-yellow-500 fill-current"
                      >star</span
                    >
                    8.9</span
                  >
            ...
            <div class="group flex flex-col gap-3 cursor-pointer">
              ...
              >
                <img
                  alt="Animated movie poster"
                  class="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuBC0_DE0ACE3E_4hgAUoCCwD5tf3j7LjbywJZYrakU3vbOG9DEADsF6RTCiWDQO6Y7fw4QQjUjxeH2XzsuveBCu_4qgYC-AlkkIrfGE_2ZtlXeaIu6cX9uQcY538dnYRhrAHP8MYty1M4pG6i1AmuR2OVPjZBJ2cbBOFf_Z_N5kl9_yc6JN0SIITK41BTU_Ng8fLGW40tH1zTq_QsyUlWHIg7wbSfCBdQNVqFt9aUAOd3yKq10SOJlO9xIT5DEoBfahwxXPhdjWaj_n"
                />
                <div
                  class="absolute top-2 left-2 px-2 py-1 bg-primary text-white rounded text-xs font-bold shadow-lg"
                >
                  New Episode
                </div>
                <div
            ...
            <div class="group flex flex-col gap-3 cursor-pointer">
              ...
              >
                ...
                />
                <div
                  class="absolute bottom-0 left-0 w-full h-1 bg-surface-highlight"
                >
            ...
            <div class="group flex flex-col gap-3 cursor-pointer">
              ...
              >
                <img
                  ...
                  class="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuDQE1N7AMsna_NMgzWmLtU6XGS6Onsq5DH841sxRd8Jg7kPLRmsjfgqeha37ZLxuG5XtkK-sc7H1YZqFdzOMRfP_EZJWkb7MSfmdSQ8g-ffG7FiXUC0heCSvQhlaI0L6bTZoMEh1dgQDMdCTGiD48AK9YQSzZWCtMEdg2v_TsMUj5KaW1aPXfOeZdn5_CBFVDUuloYruXm2lgqQX4gY9p0hmmgqfGqXeu7-xdxvAVBg1Tmq0daozRlfAL3TwFQOXrp-17EbBBOs2vPJ"
                />
              </div>
              <div class="flex flex-col gap-1">
                <h3
            ...
            <div class="group flex flex-col gap-3 cursor-pointer">
              ...
              >
                <img
                  alt="Adventure movie poster"
                  class="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuCgdwQOxkncFGsgPkNogNRgKzLq_mzZKJ6lc8gc66sJ8TzvMBvMWzSfDgL5qJDe8B1VyqpNHV0z4x1lJQAzsXu_Mr0WcF0nfr-wSDqznKWZYsy8vPUhjjmyYOUZrxrmHE-et38jRfjYcyfSV210cRwGECcSbk6uaQsbV8dMX6bBvVNpjjmpX8GfAR_kh5O7HBPvgU12oUSYF2UyR18Tm8bmJGhwPnjbnMtmyfF4aRhdTnNJ8Jbm_vmtRWgcUjz-uTsZWWd7mAuognHF"
                />
              </div>
              <div class="flex flex-col gap-1">
                <h3
          ...
          <div class="flex justify-center pb-8">
            <button
              class="h-10 px-6 rounded-full border border-surface-highlight hover:bg-surface-highlight text-white text-sm font-medium transition-colors flex items-center gap-2"
            >
              <span>Load More</span>
              <span class="material-symbols-outlined text-[18px]"
                >expand_more</span
      ...
      <!-- Mobile Bottom Nav -->
      <nav
        class="md:hidden fixed bottom-0 left-0 w-full bg-surface-dark border-t border-surface-highlight py-2 px-6 flex justify-between items-center z-50"
      >
        <a
          class="flex flex-col items-center gap-1 text-text-secondary hover:text-white"
          href="#"
        >
        ...
        <a class="flex flex-col items-center gap-1 text-primary" href="#">
          <span class="material-symbols-outlined text-[24px] fill-current"
      ...
      <button
        class="md:hidden fixed bottom-20 right-4 size-14 rounded-full bg-primary text-white shadow-lg shadow-primary/40 flex items-center justify-center z-50"
      >
...
<main class="flex-1 flex flex-col">
    ...
    <section class="relative w-full h-[320px] overflow-hidden rounded-3xl group">
        ...
        <div class="absolute inset-0 bg-gradient-to-t from-background-dark via-background-dark/20"></div>

        <button class="absolute top-4 right-4 p-2 bg-black/40 backdrop-blur-md rounded-full text-white opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <div class="relative max-w-7xl mx-auto px-6 h-full flex items-end pb-12">
            <div class="flex flex-col md:flex-row items-end gap-6">
                ...
                <div class="relative group/avatar">
                    <img class="w-32 h-32 md:w-40 md:h-40 rounded-2xl border-4 border-background-dark object-cover shadow-2xl"
                         src="https://randomuser.me/api/portraits/men/32.jpg" id="profile-preview"/>
                    
                    <label for="avatar-upload" class="absolute inset-0 flex items-center justify-center bg-black/60 rounded-2xl opacity-0 group-hover/avatar:opacity-100 transition-opacity cursor-pointer">
                        <span class="material-symbols-outlined text-white text-3xl">add_a_photo</span>
                        <input type="file" id="avatar-upload" class="hidden" accept="image/*" onchange="previewImage(event)">
                    </label>
                </div>

                <div class="mb-2">
                    <h2 class="text-4xl font-bold text-white">Alex Morgan</h2>
            ...
            <div class="lg:col-span-8 space-y-6">
                <div class="bg-surface-container-low p-8 rounded-2xl border border-outline-variant">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div class="space-y-2">
                            <label class="text-sm text-on-surface-variant">First Name</label>
                            <input class="w-full p-4 rounded-xl bg-background-dark border border-outline-variant focus:ring-2 focus:ring-primary/50 outline-none transition-all" value="Alex"/>
                        </div>
                        <div class="space-y-2">
                            <label class="text-sm text-on-surface-variant">Last Name</label>
                            <input class="w-full p-4 rounded-xl bg-background-dark border border-outline-variant focus:ring-2 focus:ring-primary/50 outline-none transition-all" value="Morgan"/>
                        </div>
                    </div>

                    <div class="space-y-2 mb-6">
                        <label class="text-sm text-on-surface-variant">Bio</label>
                        <textarea rows="4" class="w-full p-4 rounded-xl bg-background-dark border border-outline-variant focus:ring-2 focus:ring-primary/50 outline-none transition-all">Streaming Experience Designer and movie marathon enthusiast.</textarea>
                    </div>

                    <div class="flex justify-end gap-4">
                        <button class="px-6 py-3 text-on-surface-variant hover:text-white transition-colors">Discard</button>
                        <button class="px-8 py-3 bg-primary hover:bg-blue-600 text-white rounded-xl font-bold shadow-lg shadow-primary/20 transition-all">Save Changes</button>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="bg-surface-container-low p-6 rounded-2xl border border-outline-variant">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="p-4 bg-background-dark rounded-xl border border-outline-variant text-center">
                            <p class="text-2xl font-bold">142</p>
                            <p class="text-[10px] uppercase tracking-wider text-on-surface-variant">Watched</p>
                        </div>
                        <div class="p-4 bg-background-dark rounded-xl border border-outline-variant text-center">
                            <p class="text-2xl font-bold">24</p>
                            <p class="text-[10px] uppercase tracking-wider text-on-surface-variant">Reviews</p>
                        </div>
                    </div>
                </div>

                <div class="bg-gradient-to-br from-primary/20 to-purple-500/20 p-6 rounded-2xl border border-primary/20">
                    <h4 class="font-bold mb-2">StreamSync Pro</h4>
                    <p class="text-sm text-on-surface-variant mb-4">Your plan expires in 12 days. Renew now to keep 4K access.</p>
                    <button class="w-full py-3 bg-white text-black rounded-xl text-sm font-bold hover:bg-slate-200 transition-colors">
                        Manage Plan
                    </button>
                </div>

                <div class="space-y-2">
                    <a href="#" class="flex items-center justify-between p-4 bg-surface-container-low border border-outline-variant rounded-xl hover:bg-surface-container-high transition-colors group">
                        <div class="flex items-center gap-3">
                            <span class="material-symbols-outlined text-on-surface-variant">history</span>
                            <span class="text-sm">Watch History</span>
                        </div>
...
<div class="flex items-center justify-center min-h-[calc(100vh-80px)] bg-slate-50 dark:bg-background-dark px-4">
    <div class="max-w-md w-full bg-white dark:bg-[#1e293b] p-8 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800">

        <div class="text-center mb-8">
            <h2 class="text-3xl font-bold text-slate-900 dark:text-white">Join StreamSync</h2>
            <p class="text-slate-500 dark:text-slate-400 mt-2">Create your account to start watching</p>
        </div>
        ...
        <form method="post" class="space-y-4">
            ...
            {% for field in form %}
                <div class="flex flex-col gap-1">
                    ...
                    {% if field.help_text %}
                        <p class="text-[11px] text-slate-400 ml-1 leading-tight">{{ field.help_text }}</p>
                    {% endif %}
            ...
            <button type="submit" class="w-full bg-primary hover:bg-primary/90 text-white font-bold py-3 rounded-xl transition-all shadow-lg shadow-primary/20 mt-4">
                Sign Up
            </button>
        </form>
...
<style>
    /* Esto inyecta estilos a los inputs que genera Django automáticamente */
    input {
        width: 100%;
    ...
    input:focus {
        outline: none;
        ring: 2px;
        border-color: #3b82f6; /* Tu color primary */
    }
</style>
{% endblock %}
...
```md
# CodeBundle: SoftwareProject
Generated: 2026-04-22T23:28:24.377Z
Root: /home/nat/GitHub/SoftwareProject
Files: 62
...
- `app/templates/components/card_series.html` (3271 bytes)
- `app/templates/components/footer.html` (619 bytes)
- `app/templates/components/navbar.html` (6195 bytes)
- `app/templates/pages/catalog.html` (240 bytes)
- `app/templates/pages/content_view.html` (6898 bytes)
- `app/templates/pages/home.html` (19757 bytes)
- `app/templates/pages/main.html` (27320 bytes)
...
- `app/templates/registration/singup.html` (2474 bytes)
- `app/tests.py` (60 bytes)
- `app/urls.py` (538 bytes)
- `app/views.py` (2570 bytes)
- `docker-compose.yml` (938 bytes)
- `Dockerfile` (390 bytes)
- `entrypoint.sh` (173 bytes)
- `IshikawaTools/chart.py` (4069 bytes)
    ...
    <div class="relative" id="user-menu-wrapper">
      ...
      <div id="user-dropdown" class="hidden absolute right-0 mt-2 w-52 origin-top-right rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl z-[60] overflow-hidden">
        <div class="p-2 flex flex-col gap-1">
          ...
          <a href="#" class="flex items-center gap-3 px-3 py-2.5 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-colors">
            <span class="material-symbols-outlined text-primary">video_library</span>
            Personal Library
          </a>
