...
Generated: 2026-04-16T08:15:58.361Z
...
- `app/templates/components/navbar.html` (4459 bytes)
- `app/templates/pages/catalog.html` (5576 bytes)
- `app/templates/pages/home.html` (17520 bytes)
- `app/templates/pages/main.html` (27320 bytes)
- `app/templates/pages/movies.html` (2842 bytes)
- `app/templates/pages/search.html` (9187 bytes)
- `app/templates/pages/series.html` (2852 bytes)
- `app/templates/registration/login.html` (188 bytes)
- `app/templates/registration/singup.html` (2474 bytes)
- `app/tests.py` (60 bytes)
- `app/urls.py` (378 bytes)
- `app/views.py` (1183 bytes)
...
- `SoftwareProject/settings.py` (3416 bytes)
- `SoftwareProject/urls.py` (947 bytes)
      ...
      {% if user.is_authenticated %}
        ...
        <div class="flex items-center gap-2">
          ...
          <form action="{% url 'logout' %}" method="post" class="flex items-center">
            {% csrf_token %}
            <button type="submit" class="p-2 rounded-full text-slate-500 hover:text-red-500 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" title="Logout">
