# Generated by Django 6.0.5 on 2026-05-20 15:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('backdrop_url', models.URLField(blank=True, max_length=500, null=True, verbose_name='Backdrop URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p_manager', models.ForeignKey(limit_choices_to={'role__name': 'manager'}, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Catalog',
